# Economic Crimes in Latin America Dashboard
...
[![Pages](https://img.shields.io/badge/Live-Dashboard-brightgreen)](https://juanmoisesd.github.io/economic-crimes-latam/)
[![DOI](https://img.shields.io/badge/DOI-10.7910/DVN/8FXZOJ-blue)](https://doi.org/10.7910/DVN/8FXZOJ)


## Overview

Interactive dashboard: Economic crimes in Latin America (2020-2023). Corruption, Money Laundering, Tax Evasion, Fraud, Organized Crime. 20 countries. DOI: 10.7910/DVN/8FXZOJ

## 🌐 Live Dashboard

**[Open Interactive Dashboard](https://juanmoisesd.github.io/economic-crimes-latam/)**

## Resources

| Resource | Link |
|---|---|
| Dataset DOI | [doi.org/10.7910/DVN/8FXZOJ](https://doi.org/10.7910/DVN/8FXZOJ) |
| Author | [juanmoisesdelaserna.es](https://juanmoisesdelaserna.es) |
| ORCID | [0000-0002-8401-8018](https://orcid.org/0000-0002-8401-8018) |

## How to Cite

> de la Serna Tuya, J.M. (2026). *Economic Crimes in Latin America Dashboard*. GitHub. https://github.com/juanmoisesd/economic-crimes-latam
Also cite the dataset: https://doi.org/10.7910/DVN/8FXZOJ
...
|---|---|
| Status | 🟢 Published |
| DOI | [10.7910/DVN/8FXZOJ](https://doi.org/10.7910/DVN/8FXZOJ) |
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Interactive dashboard: Economic crimes in Latin America (2020-2023). Corruption, Money Laundering, Tax Evasion, Fraud, Organized Crime. 20 countries. DOI: 10.7910/DVN/8FXZOJ* [Dataset]. GitHub. https://github.com/juanmoisesd/economic-crimes-latam

**BibTeX**
```bibtex
@dataset{delaserna2025_economic_crimes_latam,
  author    = {De la Serna Tuya, Juan Moisés},
  title     = {Interactive dashboard: Economic crimes in Latin America (2020-2023). Corruption, Money Laundering, Tax Evasion, Fraud, Organized Crime. 20 countries. DOI: 10.7910/DVN/8FXZOJ},
  year      = {2025},
  publisher = {GitHub},
  url       = {https://github.com/juanmoisesd/economic-crimes-latam},
